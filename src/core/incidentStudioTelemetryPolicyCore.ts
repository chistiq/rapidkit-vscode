/**
 * Shared telemetry → policy gate evaluation (host source of truth).
 * Webview mirror: webview-ui/src/lib/incidentStudioTelemetryPolicyCore.ts
 * Keep in sync — guarded by incidentStudioPolicyGateParity.test.ts
 */
