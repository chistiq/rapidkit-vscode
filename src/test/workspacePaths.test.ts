...
describe('workspacePaths', () => {
  ...
  it('detects default workspace creation paths', () => {
    const homeDir = '/home/test-user';
    const workspacePath = resolveNewWorkspacePath('my-mini-wsp', { homeDir });

    expect(isDefaultWorkspaceCreationPath(workspacePath, 'my-mini-wsp', homeDir)).toBe(true);
    expect(isDefaultWorkspaceCreationPath('/tmp/custom/my-mini-wsp', 'my-mini-wsp', homeDir)).toBe(
      false
    );
  });
