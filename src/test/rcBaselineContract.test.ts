...
describe('RC baseline contract', () => {
  it('pins the extension release line to Workspai CLI 0.52.0 and extension 0.35.0', () => {
    ...
    expect(MIN_RAPIDKIT_CLI_VERSION).toBe('0.52.0');
    expect(matrix.npmTruthBaseline).toBe('0.52.0');
