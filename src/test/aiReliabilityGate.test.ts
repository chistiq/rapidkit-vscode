...
const STACK_FIXTURES: StackFixture[] = [
  {
    ...
    expectedPromptSignal: 'ACTIVE KIT ARCHITECTURE: fastapi.standard',
  ...
  },
  {
    ...
    expectedPromptSignal: 'ACTIVE KIT ARCHITECTURE: nestjs.standard',
    moduleSupportExpected: true,
  },
  {
    framework: 'go',
    ...
    expectedPromptSignal: 'ACTIVE KIT ARCHITECTURE: gofiber.standard',
  ...
  },
  {
    ...
    expectedPromptSignal: 'ACTIVE KIT ARCHITECTURE: springboot.standard',
    moduleSupportExpected: false,
  },
  {
    framework: 'dotnet',
    ...
    expectedPromptSignal: 'ACTIVE KIT ARCHITECTURE: dotnet.webapi.clean',
    moduleSupportExpected: false,
  },
];
