                    ...
                    return (
                        ...
                        >
                            <div className="evidence-outcome-panel__item-head">
                                ...
                                <span className="evidence-outcome-panel__badge">
                            ...
                            <div className="evidence-outcome-panel__actions">
                                {runCommand ? (
                                    <button
                                        type="button"
                                        className="evidence-outcome-panel__action"
                                ...
                                {studioTarget ? (
                                    <button
                                        type="button"
                                        className="evidence-outcome-panel__action evidence-outcome-panel__action--primary"
